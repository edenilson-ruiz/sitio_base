    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Actualizar Area de Atención</h5>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model.lazy="tiempo_atencion_min" type="text" class="form-control"
                            id="tiempo_atencion_min" placeholder="Tiempo de atencion en minutos">@error('tiempo_atencion_min')
